...
(use-package org-roam
  ...
  (org-roam-file-exclude-regexp (rx (or "data/" "index.org" "gtd/")))
  ...
  (defvar-keymap my-org-leader-map
    "i" (cons "insert node"   #'org-roam-node-insert)
    "o" (cons "create id"     #'org-id-get-create)
    "t" (cons "add tag"       #'org-roam-tag-add)
    "a" (cons "add alias"     #'org-roam-alias-add)
    "l" (cons "toggle buffer" #'org-roam-buffer-toggle))
  (evil-define-key '(normal visual motion) org-mode-map
    (kbd "SPC m") my-org-leader-map)

  (keymap-set my-notes-map "f" (cons "find note" #'org-roam-node-find))
  (keymap-set my-notes-map "r" (cons "random note" #'org-roam-node-random)))
#+end_src
